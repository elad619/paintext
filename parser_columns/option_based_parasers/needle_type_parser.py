...
def parse_document(text_searcher: TextSearcher) -> str:
    found_needle_types = text_searcher.get_words_if_found(NEEDLE_TYPES)
    return ",".join(found_needle_types.original_values) if found_needle_types else MISSING_VALUE
